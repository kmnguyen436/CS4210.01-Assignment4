#-------------------------------------------------------------------------
# AUTHOR: Kayla Nguyen
# FILENAME: KaylaNguyen_Assignment4Q2.py
# SPECIFICATION: A python program that read a training set to build
# a Single Layer Perceptron and a Multi-Layer Perceptron Classifier.
...
accuracy = 0
maxAccuracyP = 0.000001
maxAccuracyM = 0.000001
max
for w in n: #iterates over n
    ...
    for b in r: #iterates over r
        ...
        for a in range(2): #iterates over the algorithms
            ...
            if accuracy > maxAccuracyP and a==0:
                maxAccuracyP = accuracy
                print("Highest Perceptron accuracy so far:", maxAccuracyP, "Parameters: learning rate="+str(w)+", shuffle="+str(b))
            elif accuracy > maxAccuracyM and a!=0:
                maxAccuracyM = accuracy
                print("Highest "
                      "MLP accuracy so far:", maxAccuracyM,
